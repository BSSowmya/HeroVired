...
class Main extends React.Component{
    ...
    render(){
        return(
            <>
            <section className="first" id="section1">
        <h1 className="main_class"><u>The Joy of Giving</u></h1>
        <p>
        ...
        <section id ="section2">
        <h1 className="main_class"><u>The Benefits of Why giving?</u></h1>
        <p>
        ...
        <ul>
         <li>You get a feeling of satisfaction and fulfilment when you donate money to NGOs.</li>   
         <li>The more you give, the richer you feel!</li>   
         <li>Your small donation makes a lot of difference.</li>   
         <li>A sense of giving back to the society you are a part of.</li>   
        </ul>
        ...
        <section id="section3">
        <h1 className="main_class"><u>The power of giving and the joy of helping others</u></h1>
        <p>
